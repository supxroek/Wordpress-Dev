...
<div class="wpte-info-block">
	<p><?php esc_html_e( 'Want to provide downloadable files such as brochures, guidebooks, offline maps, etc? File Downloads extension allows you to upload files in various formats that can be downloaded by travellers.', 'wp-travel-engine' ); ?> <a target="_blanks" href="https://wptravelengine.com/plugins/file-downloads/?utm_source=free_plugin&utm_medium=pro_addon&utm_campaign=upgrade_to_pro"><?php esc_html_e( 'Get File Downloads extension now.', 'wp-travel-engine' ); ?></a>
	</p>
</div>
