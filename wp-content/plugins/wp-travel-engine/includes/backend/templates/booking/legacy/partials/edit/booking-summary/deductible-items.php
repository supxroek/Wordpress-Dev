...
/**
 * @var array $deductible_items
 */
?>
<tr class="title">
	<td colspan="1"><strong><?php echo esc_html( 'Discounts' ); ?></strong></td>
	<td>
		<?php if ( $is_booking_edit_enabled ) : ?>
		<button type="button" class="wpte-button wpte-link"
				data-template="cart-adjustment-line-item"
				data-target="[data-line-item__discounts_section]"
				data-args="
				<?php
				echo esc_attr(
					wp_json_encode(
...
<tr>
	<td colspan="2" style="padding: 0;">
		<table data-line-item__discounts_section>
			<?php
