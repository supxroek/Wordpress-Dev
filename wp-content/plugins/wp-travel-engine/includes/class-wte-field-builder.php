	...
	public function field() {
		...
		switch ( $this->type ) {
			case 'text':
				...
				$field = '<input ' . $this->get_attributes() . '/>'; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				break;
			case 'textarea':
				$value = $this->value ? $this->value : $this->default_value;
				$field = '<textarea ' . $this->get_attributes() . '>' . $this->value . '</textarea>'; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				break;
			case 'number':
				$value = $this->value ? $this->value : $this->default_value;
				$field = '<input ' . $this->get_attributes() . '/>'; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			...
			case 'select':
				...
				ob_start();
				?>
				<select <?php echo $this->get_attributes(); ?>><!-- phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -->
					<?php
			...
			case 'checkbox':
				...
				<input <?php echo $this->get_attributes(); ?> /><!-- phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -->
				<?php
				$field           = ob_get_clean();
			...
			case 'datepicker':
				ob_start();
				?>
				<input type="text" <?php echo $this->get_attributes(); ?> /><!-- phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -->
				<?php
				$field = ob_get_clean();
				break;
		}
		...
		<div class="<?php echo esc_attr( $wrapper_classes ); ?>">
			...
			if ( $this->tooltip ) {
				echo '<span class="wpte-tooltip">' . wp_kses(
					$this->tooltip,
					array(
						'a' => array(
							'href'   => array(),
