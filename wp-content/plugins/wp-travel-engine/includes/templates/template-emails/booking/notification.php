	...
	<table style="width:100%;">
		<tr>
			<td colspan="2" style="font-size: 24px;line-height: 1.5;font-weight: bold;">
				<?php echo WTE_Booking_Emails::get_string( 'order', $args['sent_to'], 'heading' ); ?>
			</td>
		</tr>
		<tr>
			<td colspan="2" style="padding: 16px 0 8px;">
			<strong><?php echo WTE_Booking_Emails::get_string( 'order', $args['sent_to'], 'greeting' ); ?></strong>
			<p style="margin: 8px 0 0;"><?php echo WTE_Booking_Emails::get_string( 'order', $args['sent_to'], 'greeting_byline' ); ?></p>
			</td>
		</tr>
		<tr>
			<td colspan="2">
		...
		<tr>
			<td colspan="2">
				<?php echo WTE_Booking_Emails::get_string( 'order', $args['sent_to'], 'footer' ); ?>
			</td>
		</tr>
	</table>
